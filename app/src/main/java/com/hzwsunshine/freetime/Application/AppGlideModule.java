...
//
//
//        VolleyUrlLoader.Factory factory=new VolleyUrlLoader.Factory(context);
//
//        Glide.get(context).register(GlideUrl.class, InputStream.class,
//                new VolleyUrlLoader.Factory(VolleySingleton.getVolleySingleton(context).getRequestQueue()));
    }
}
