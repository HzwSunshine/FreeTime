...
public class GreenDao {
    public static void main(String[] args) throws Exception {
        ...
        Schema schema = new Schema(1, "FreeTime.greenDao");
...
//      schema.setDefaultJavaPackageDao("me.itangqi.dao");
    ...
    private static void addNote(Schema schema, String tableName) {
        ...
        //数据总条数
        note.addStringProperty("totalDataNum");
        //URL类型
        note.addStringProperty("urlType");

    }

    private static void CSDN(Schema schema, String tableName) {
        Entity note = schema.addEntity(tableName);
        note.addIdProperty().primaryKey().autoincrement();
        note.addStringProperty("title");
        note.addStringProperty("date");
        note.addStringProperty("imgLink");
